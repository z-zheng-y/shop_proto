...
type GoodsFilterRequest struct {
	...
	TopCategory bool   `protobuf:"varint,6,opt,name=topCategory,proto3" json:"topCategory,omitempty"` //是否是顶级分类
...
func (x *GoodsFilterRequest) GetTopCategory() bool {
	if x != nil {
...
var file_goods_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x74, 0x6f,
